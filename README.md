...
При поиске минимума целевой функции $f(x)$ пробные векторы $x$ могут быть выбраны в точках $E^n$, находящихся в вершинах симплекса, как было первоначально предложено Спендли, Хекстом и Химсвортом. Координаты вершин регулярного симплекса определяются следующей матрицей $D$, в которой столбцы представляют собой вершины, пронумерованные от $1$ до $n+1$, а строчки - координаты, $i$ принимает значение от $1$ до $n$.
$$D=\begin{pmatrix} 0&d_1&d_2&...&d_2 \\ 0&d_2&d_1&...&d_2 \\ 0&d_2&d_2&...&d_2 \\ ...&...&...&...&... \\ 0&d_2&d_2&...&d_1 \end{pmatrix}\;-\;\text{матрица }n\times(n+1),$$
где
$$d_1=\frac{t}{n\sqrt{2}}\cdot\left(\sqrt{n+1}+n-1\right)$$
$$d_2=\frac{t}{n\sqrt{2}}\cdot\left(\sqrt{n+1}-1\right),$$
где $t-$расстояние между двумя вершинами.
